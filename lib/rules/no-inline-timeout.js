...
module.exports = {
  meta: {
    ...
    hasSuggestions: true, 
    messages: {
      inlineTimeout: "Code smell detected: Inline timeout overrides make tests hard to scale across different CI environments. Rely on the global timeout instead.",
      testSetTimeout: "Code smell detected: Test Timeout Inflation. Using test.setTimeout() breaks project standardization and hides poor synchronization.",
