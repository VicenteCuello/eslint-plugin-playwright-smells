...
module.exports = {
  meta: {
    ...
    messages: {
      ...
      replaceWithToHaveCount: "Suggestion: Replace with the web-first assertion toHaveCount() (incorporates auto-waiting)"
    },
    schema: [],
  },
      ...
      CallExpression(node) {
        ...
        if (node.callee && node.callee.type === "MemberExpression") {
          ...
          if (expectCall && expectCall.type === "CallExpression" && expectCall.callee.name === "expect") {
            ...
            // Internal function to inject the Web-First solution
